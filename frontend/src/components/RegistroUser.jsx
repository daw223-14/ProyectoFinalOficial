                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="row g-2">
                                <div data-mdb-input-init className="col-sm form-outline mb-3">
                                    ...
                                    <input className="form-control form-control-lg" id="password" type="password" placeholder="Contraseña..." name="contrasena" value={formData.contrasena} onChange={handleChange} required />
                                </div>
                                <div data-mdb-input-init className="col-sm form-outline mb-3">
                                    <label htmlFor="password2" className="form-label">Repita la contraseña</label>
                                    <input className="form-control form-control-lg" id="password2" type="password" placeholder="Repite la contraseña..." name="contrasena2" value={formData.contrasena2} onChange={handleChange} required />
                                </div>
                            </div>
